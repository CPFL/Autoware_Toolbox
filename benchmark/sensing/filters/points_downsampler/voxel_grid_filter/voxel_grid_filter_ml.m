global pub_voxel_grid_filter

node_voxel_grid_filter = robotics.ros.Node('voxel_grid_filter_ml');
sub_voxel_grid_filter = robotics.ros.Subscriber(node_voxel_grid_filter, '/points_raw', 'sensor_msgs/PointCloud2', @voxel_grid_filter_callback);
pub_voxel_grid_filter = robotics.ros.Publisher(node_voxel_grid_filter, '/filtered_points', 'sensor_msgs/PointCloud2');
...
function voxel_grid_filter_callback(~, msg)
	...
	send(pub_voxel_grid_filter, ptMsg);
